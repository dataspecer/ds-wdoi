...
def __separate_to_files(bz2_input_file, classes_output_file, properties_output_file, wd_entity_ids_set: set, class_counter, property_counter):    
...
@timed(logger)
def separate_to_files(bz2_dump_file_path: pathlib.Path, wd_entity_ids_set: set):
    with (bz2.BZ2File(bz2_dump_file_path) as bz2_input_file,
          ...
          bz2.BZ2File(PROPERTIES_OUTPUT_FILE, "w") as properties_output_file
            ...
            __separate_to_files(bz2_input_file, classes_output_file, properties_output_file, wd_entity_ids_set, class_counter, property_counter)
