...
from experiments.execute_seach_queries.execute_search_queries import main_methods_without_reranking, main_methods_with_boost_reranker, main_final_methods_with_cross_encoder
...
main_final_methods_with_cross_encoder("./search_queries.json")