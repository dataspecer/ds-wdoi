...
def transform_classes(bz2_file_path: pathlib.Path):
    ...
    __transform_entities(bz2_file_path, CLASSES_OUTPUT_FILE, transform_wd_class, wd_entity_types.is_wd_entity_item, logger, CLASSES_LOGGING_PROGRESS_STEP)
    
def transform_properties(bz2_file_path: pathlib.Path):
    logger = main_logger.getChild("p3_transform_properties")
    __transform_entities(bz2_file_path, PROPERTIES_OUTPUT_FILE, transform_wd_property, wd_entity_types.is_wd_entity_property, logger, PROPERTIES_LOGGING_PROGRESS_STEP)
